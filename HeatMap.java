...
public class HeatMap {
    ...
    private Collection<Position> mData;
    ...
    public void setWeightedData(Collection<Position> data) {
        if (data.isEmpty()) {
    ...
    public static class Builder {
        private Collection<Position> data;
        ...
        public Builder weightedData(Collection<Position> val) {
            this.data = val;
